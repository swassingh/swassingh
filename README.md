...
[![Email](https://img.shields.io/badge/Email-swastik.singh%40gmail.com-success)](mailto:swastik.singh@gmail.com)
...
[[Repo]](https://github.com/swassingh/PromptFit)

---

#### 🔍 Hadoop Search
**Goal:** Develop a semantic search and recommendation engine for Apache Hadoop documentation.  
...
### 🧰 Tech Toolbox
**Data**: SQL · Trino · OpenSearch · Airflow  
**ML/LLM**: PyTorch · LangChain · RAG · Text-to-SQL  
**Infra**: AWS (S3, Glue, Athena, IAM) · Docker · Kubernetes (basics)

---

### 🔭 Now
- Expanding **LLMGuard** with context-aware evaluators for AI security  
- Practicing **golf** and trying to perfect my fade shot ⛳  

---

### 🤝 Open to
Collaborations in **Data Science**, **Data Engineering**, **AI/ML Development**, **AI Security**, **Data Platforms**, and **Applied LLM Research**.

---

<sub>Fun fact: I can switch between Indian and American accents mid-sentence — my teammates say it’s my hidden debugger mode 😄</sub>
